...
author: "CSE312 Course Staff"
lang: en
description: "An introduction to HTTP requests and responses, including URLs, headers, status codes, and message structure."
keywords: [HTTP, web development, request, response, CSE312]

# Shown on the course schedule and as the closing "Further Reading" section.
reading-list:
...
# Typos corrected from the source slides, so check_fidelity.py can ignore the
# original spellings. "discus" -> "discuss" (slide 3).
fidelity-ok: [discus]

# Show Quarto Slides + Readable Page links on the course schedule.
released: true
---
...
[Read this lecture as a single page](index.html)
:::

::: {.content-visible unless-format="revealjs"}
[View this lecture as slides](slides.html)
:::
...
::: {.diagram-description role="note" aria-label="Packet structure from outermost to innermost layer"}
...
1. Request HTML
2. Sends HTML
3. Request Each url in HTML
4. Sends Content
5. Browser renders all content and runs JavaScript
:::
